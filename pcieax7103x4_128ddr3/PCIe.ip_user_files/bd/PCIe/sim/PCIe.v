...
module PCIe
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:pcie_7x_mgt:1.0 pci_exp rxn" *) input [3:0]pci_exp_rxn;
  (* X_INTERFACE_INFO = "xilinx.com:interface:pcie_7x_mgt:1.0 pci_exp rxp" *) input [3:0]pci_exp_rxp;
  (* X_INTERFACE_INFO = "xilinx.com:interface:pcie_7x_mgt:1.0 pci_exp txn" *) output [3:0]pci_exp_txn;
  (* X_INTERFACE_INFO = "xilinx.com:interface:pcie_7x_mgt:1.0 pci_exp txp" *) output [3:0]pci_exp_txp;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_clock:1.0 sys_ddr CLK_N" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME sys_ddr, CAN_DEBUG false, FREQ_HZ 200000000" *) input sys_ddr_clk_n;
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_clock:1.0 sys_ddr CLK_P" *) input sys_ddr_clk_p;
  ...
  PCIe_axi_mem_intercon_0 axi_mem_intercon
  ...
  PCIe_rst_mig_7series_0_100M_1 rst_mig_7series_0_100M
       (.aux_reset_in(1'b1),
...
module PCIe_axi_mem_intercon_0
   (ACLK,
    ARESETN,
    M00_ACLK,
    M00_ARESETN,
  ...
  s00_couplers_imp_W4X1JL s00_couplers
...
module s00_couplers_imp_W4X1JL
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arburst,
